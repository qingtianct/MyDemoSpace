...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of CTPasswordView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/1295890900@qq.com/CTPasswordView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '1295890900@qq.com' => 'chengtao@jxgtmbjt.com' }
  s.source           = { :git => 'https://github.com/1295890900@qq.com/CTPasswordView.git', :tag => s.version.to_s }
...
#  s.resource = 'CTPasswordView/Classes/CTPassword.bundle'
  s.resource = ['Resources/CTPassword.bundle','CTPasswordView/Assets/*.xcassets']
#  s.resource = ['CTPasswordView/Assets/*.png']
   s.resource_bundles = {
